  ...
  return (
    <section className="w-full">
      <Container className="relative lg:absolute z-50 lg:left-1/2 lg:-translate-x-1/2 lg:translate-y-1/2 lg:bottom-0 py-0">
        ...
        <div className="rounded-[30px] bg-gradient-to-br from-[#f8f3e9] via-[#d7bb77] to-[#f8f3e9] p-[1.5px] shadow-[0_18px_45px_rgba(0,0,0,0.08)]">
          {/* Inner Container */}
          <div className="rounded-[29px] border border-[#f5f0e4] bg-white px-4 py-2">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
              {features.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`relative flex items-center gap-5 px-4 py-4 ${
