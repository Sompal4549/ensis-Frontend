...
export default function BlogHeroSection({ sectionContent }: { sectionContent: any }) {
  return (
    <section className="w-full bg-[#f8f1e7] overflow-visible relative mb-40 md:mb-20">
      ...
      <Container className="grid md:min-h-[calc(100vh-146px)] max-h-[650px] grid-cols-1 lg:grid-cols-2 relative z-20 items-center">
        {/* Left Content */}
