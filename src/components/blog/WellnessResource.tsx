  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#e4d5c2] bg-gradient-to-br from-[#f7efe5] to-[#f2e5d5] p-5 min-h-[150px] flex justify-between items-start group">
      ...
      <div className="relative z-10 max-w-[55%]">
        ...
        <p className="text-[#4f4337] text-sm leading-6 mt-3">
          {description}
        </p>

        <button className="mt-5 text-[#9c6427] text-sm font-medium flex items-center gap-2 hover:gap-3 transition-all">
          {linkText}
          <span>→</span>
        </button>
      </div>
