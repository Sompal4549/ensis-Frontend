...
export default function NewsletterCard() {
  return (
    <div className="rounded-3xl border border-[#dcc9b5] bg-[#efe4d7] p-4">
      ...
      <p className="mx-auto mt-4 max-w-[260px] text-center text-[15px] leading-7 text-[#6e5b4d]">
      ...
      <div className="mt-6">
        ...
        <button className="mt-4 h-12 w-full rounded-lg bg-[#274217] text-sm font-medium text-white">
          Subscribe
        </button>
      </div>
    </div>
