...
export default async function BlogDetailPage({ params }: BlogDetailProps) {
  ...
  return (
    <main className="py-12 md:py-20 bg-[#fdfaf5]">
      <Container>
        <div className="grid grid-cols-1 gap-12 xl:grid-cols-[1fr_320px]">
          ...
          <article className="max-w-4xl">
            ...
            <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl font-bold text-[#2b241f] leading-[1.1] mb-8">
              {blog.title}
            </h1>

            <div className="relative aspect-[21/10] w-full overflow-hidden rounded-[2.5rem] mb-12 shadow-sm">
              <Image
                src={blog.featureImage ? getImageUrl(blog.featureImage) : (blog.image ? getImageUrl(blog.image) : "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=80&w=2070")}
                alt={blog.title}
                fill
...
/**
 * Generates static paths for all blogs found in the system
 */
